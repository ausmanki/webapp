...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', help='DefectDojo Hostname',
                        required=True)
    parser.add_argument('--api_key', help='API Key', required=True)
    parser.add_argument('--username',
                        help='Username of Defect dojo user',
                        required=True)
    ...
    parser.add_argument('--scanner', help='Type of scanner',
                        required=True)
    parser.add_argument('--product_id', help='DefectDojo Product ID',
                        required=False)
    parser.add_argument('--build_id',
                        help='Reference to external build id',
                        required=False)
